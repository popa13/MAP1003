...
## Implementation from scratch d'un reseau de neuron
## Reference : https://medium.com/@derek246810/building-an-xor-neural-network-from-scratch-learn-from-the-basics-63a2a22495ae
...
class NeuralNetwork:
    ...
    def train(self, inputs, outputs):
        for epoch in range(self.epochs):
            ...
            # Print MSE every 1000 epochs and visualize progress
            if epoch % 100 == 0:
...
## Values of the XOR truth table
inputs = np.array([[0,0], [0,1], [1,0], [1,1]])
outputs = np.array([[0], [1], [1], [0]])

## Initialize neuron network with 1 input layer, 1 hidden layer and 1 output layer
epoch = 10000
layers = [2, 2, 1]  # 2 neurons in the input layer, 2 neurons in hidden layer, 1 neuron in output layer
nn = NeuralNetwork(layers, 0.1, epoch)
